# Part 1: AI Panel Mastery - Before/After Demonstration

## 🎯 Demo Overview

**Duration**: 15-20 minutes  
**Objective**: Demonstrate how adding context and visual aids dramatically improves AI responses in Cursor
...
### **Prerequisites**
- Cursor IDE open
- Sample code files ready (see `sample-code/part1-ai-panel/`)
- Screenshots/diagrams prepared
- Project structure visible

### **Demo Files Needed**
- `sample-code/part1-ai-panel/before-scenario.py`
- `sample-code/part1-ai-panel/after-scenario.py`
- `sample-code/part1-ai-panel/project-context.md`
- `docs/screenshots/part1/` (screenshots for context)
...
> *"Welcome to Part 1 of our Vibe Coding demonstration. Today we'll see how the AI Panel in Cursor can be transformed from a basic chat interface into a powerful development assistant through proper context management."*

**Key Points to Mention:**
- AI Panel is Cursor's primary AI interface
- Without context, AI responses are generic
- With context, AI becomes a knowledgeable team member
- Visual aids enhance understanding significantly

---

### **Scenario 1: Basic AI Chat (Before) - 5 minutes**

#### **Step 1: Show Generic Request**
> *"Let's start with a common scenario. I need to create a Python script that monitors network connections and alerts on suspicious activity."*

**Action**: Open Cursor and start a new chat with this request:
```
...
def monitor_connections():
    # Basic monitoring code
    pass

# Generic implementation without specific requirements
```

#### **Step 2: Highlight Limitations**
...
**Audience Discussion**: *"What problems do you see with this response?"*
